...
Public Class Etiquetas1
    ...
    Public Sub Etiquetas1_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        Me.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" & _
                sConnection, "spq_Reporte_Etiquetas1 @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
        ...
        Dim SubReporteEtiquetas1 As New SubEtiquetas1
        SubReporteEtiquetas1.Parameters.Clear()

        'aqui se agregan
        SubReporteEtiquetas1.Parameters.Add(ParamIdRazonSocial)
        SubReporteEtiquetas1.Parameters.Add(ParamIdElementoUsuario)
        SubReporteEtiquetas1.Parameters.Add(ParamUID)
        SubReporteEtiquetas1.Parameters.Add(ParamLID)
        SubReporteEtiquetas1.Parameters.Add(ParamidAccion)


        'aqui se les asigna el valor
        SubReporteEtiquetas1.Parameters("IdRazonSocial").Value = Me.Parameters("IdRazonSocial").Value
        SubReporteEtiquetas1.Parameters("IdElementoUsuario").Value = Me.Parameters("IdElementoUsuario").Value
        SubReporteEtiquetas1.Parameters("UID").Value = Me.Parameters("UID").Value
        SubReporteEtiquetas1.Parameters("LID").Value = Me.Parameters("LID").Value
        SubReporteEtiquetas1.Parameters("idAccion").Value = Me.Parameters("idAccion").Value
        Me.SubReport1.Report = SubReporteEtiquetas1
