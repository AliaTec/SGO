...
Public Class SubEtiquetas1
    ...
    Private Sub SubEtiquetas1_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
        ...
        sConnection, "spq_Reporte_Etiquetas1Sub @IdRazonSocial = " + Me.Parameters("IdRazonSocial").Value + "," & _
